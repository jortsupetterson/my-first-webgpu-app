...
};`}),f=e.createRenderPipeline({label:"Cell pipeline",layout:"auto",vertex:{module:c,entryPoint:"vertexMain",buffers:[d]},fragment:{module:c,entryPoint:"fragmentMain",targets:[{format:o}]}}),g=e.createBindGroup({label:"Cell rendered bind group",layout:f.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:i}}]}),l=e.createCommandEncoder(),r=l.beginRenderPass({colorAttachments:[{view:n.getCurrentTexture().createView(),loadOp:"clear",storeOp:"store",clearValue:[0,0,.4,1]}]});r.setPipeline(f),r.setVertexBuffer(0,s),r.setBindGroup(0,g),r.draw(a.length/2,1024),r.end(),e.queue.submit([l.finish()])}catch(t){document.body.insertAdjacentHTML("afterend","<span>"+t+"</span>")}
